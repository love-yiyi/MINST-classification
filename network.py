...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,test_data,
        ...
        training_error,testing_accuracy = [], []
        ...
        for j in range(epochs):
            ...
            if monitor_training_error:
                err = 1-self.evaluate(training_data)/n
        ...
        return training_error,testing_accuracy
